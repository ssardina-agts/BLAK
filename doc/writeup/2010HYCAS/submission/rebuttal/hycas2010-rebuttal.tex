...
We take the point and agree it was very hard for non-bdi experts to get a good
...
elevator controller. Please see second paragraph of Section 2.1. We have also
rephrased a bit 2nd and 3rd paragraph of that Section 2.1.}
...
Section 2.1 will help clarify why schematic plan rules and recursive calls in
programs are important. We have also third-to-last paragraph of Section 2.2
...
propositions describing the weather or features of car rental companies are
...
\shout{Please see new footnote 4.}
...
``subgoaling'') is necessary to express iterative procedures.
%%
Please see answer to question \ref{rev3:recursion_examples} above.
