...
optimisations (final paragraph of [Section 4.1 Experimental Setup]), as it is not relevant to the discussion at hand and has no bearing on the relative results.}
...
\shout{We have updated the discussion of results on page 19 to clarify this point.}
...
\shout{We have updated the related paragraph on page 20 to clarify this point.}
...
\shout{We have incorporated your suggestion and updated the paragraph.}
...
\shout{We have reworded this paragraph so it is not confusing to the reader.}
...
\shout{We have removed the reference and reworded the paragraph.}
...
\shout{TOO: We have now included references to several logistics domains used in the planning literature that are also relevant to our discussion. Where?...}
...
\shout{TODO: In procedural languages that do not provide constructs for looping, one mechanism for achieving this behaviour is through recursion. For this reason parameterised events and recursion are essential features that are heavily used in real BDI systems.}


\subsection{Also throughout the paper it is not really point out how the event types are handled in fact.}

We have tried to cover this appropriately in [Section 3.4 Handling Event-Goal Types].
...
\shout{TODO: We have now clarified this in page 7.}
...
\shout{TODO: We agree this is an important question and have addressed the issue in [Section 2.2 Learning for BDI Plan Selection].}
...
\shout{TODO: We have updated the related paragraph in [Section 4.2 Results].}
...
\shout{We assume the reviewer is referring to the assumptions on page 20. We have tried to further justify these and emphasise in [Section 5. Discussion and Conclusion] that we are not yet at the stage where our framework may be used in practical systems.}
...
\shout{We have reworked the entire related work coverage in [Section 5. Discussion and Conclusion] and have provided further related references.}
...
\shout{We have added Figure 6b and reworded [Section 4.2 Results] to further clarity this point.}
