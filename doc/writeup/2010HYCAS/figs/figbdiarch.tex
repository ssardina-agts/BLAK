...
\node  (environment)  
       ...
       starburst,fill=black!18,rotate=90,shift={(-1cm,3.4cm)}] 
...
\draw node (P) 
	[right of=deli,xshift=2.5cm,rounded corners, double copy
	shadow={opacity=0.8},text centered, entity, minimum height=6em] 
	{	\begin{tabular}{c} 
          \textbf{Plan} \\[1ex]
          \textbf{library}
         \end{tabular}	};
