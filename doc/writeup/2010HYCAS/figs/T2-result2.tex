\begin{tikzpicture}[x=0.0025cm,y=4cm]
    ...
    \draw[-] plot[mark=x,mark size=4,mark options={color=black}] 
			file {data/test05v3gm.CC.tikzdata};
...
%			file {data/test05v3gm.SC.tikzdata};
    \draw[-,thin,densely dashed,gray] plot[mark=o,mark size=2,mark options={color=gray}] 
