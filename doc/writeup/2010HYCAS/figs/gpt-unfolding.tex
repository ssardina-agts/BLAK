...
\tikzstyle{level 1}=[sibling distance=5.0cm,level distance=1.9cm] 
\tikzstyle{level 2}=[sibling distance=10.0cm,level distance=1.9cm] 
\tikzstyle{level 3}=[sibling distance=3.0cm,level distance=1.9cm]
\tikzstyle{level 4}=[sibling distance=5.0cm,level distance=2.3cm]
\tikzstyle{level 5}=[sibling distance=1.6cm,level distance=1.9cm]
...
\node[goalbox,yshift=1cm] {$G(\vec{x_1})$}
	...
	child {node[planbox] {$P_2$}
		child {node[goalbox] {$G(\vec{x_2})$}
			...
			child[densely dashed] {node[planbox] {$P_2$}
