...
% \newcommand{\fontNames}[1]{\mbox{\textsl{#1}}}
\newcommand{\fontNames}[1]{\mbox{\textit{#1}}}

\newcommand{\fontEvent}[1]{\fontNames{#1}}
\newcommand{\fontFluent}[1]{\fontNames{#1}}
\newcommand{\fontAction}[1]{\fontNames{#1}}


% Hanoi Towers
\newcommand{\eSolve}{\fontEvent{Solve}}

\newcommand{\aMove}{\fontFluent{move}}

\newcommand{\pOn}{\fontFluent{on}}
\newcommand{\pPin}{\fontFluent{pin}}

\newcommand{\disc}[1]{\fontFluent{#1}}
\newcommand{\pin}[1]{\fontFluent{#1}}
\newcommand{\Solve}[2]{\eSolve(\disc{#1},\pin{#2})}
\newcommand{\move}[2]{\aMove(\pin{#1},\pin{#2})}


% Eleevator example
\newcommand{\eServeAll}{\fontEvent{ServeAll}}
\newcommand{\eServeFloor}{\fontEvent{Serve}}
\newcommand{\eGoTo}{\fontEvent{GoTo}}

\newcommand{\pServing}{\fontFluent{Serving}}
\newcommand{\pAt}{\fontFluent{At}}

\newcommand{\aUp}{\fontAction{GoUp}}
\newcommand{\aOpen}{\fontAction{Open}}
\newcommand{\aClose}{\fontAction{Close}}
\newcommand{\aOff}{\fontAction{Off}}

% Othe examples
\newcommand{\travelTo}[1]{\fontEvent{travelTo}(\fontFluent{#1})}
\newcommand{\dest}[1]{\fontFluent{#1}}
...
\ead{\{firstname.lastname\}@rmit.edu.au} 
...
% \input{sections/extended}


\input{sections/framework}
\input{sections/hanoi}
