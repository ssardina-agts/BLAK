...
\tikzstyle{planbox}=[draw,minimum height=0.5cm,minimum width=0.5cm]
\tikzstyle{goalbox}=[draw,rounded corners,minimum height=0.5cm,minimum width=0.5cm]

\tikzstyle{level 1}=[sibling distance=3.5cm,level distance=0.3cm] 
\tikzstyle{level 2}=[sibling distance=1.5cm,level distance=0.9cm]
\tikzstyle{level 3}=[sibling distance=1.2cm,level distance=1.0cm]
\tikzstyle{level 4}=[sibling distance=1.2cm,level distance=0.9cm]
\tikzstyle{level 5}=[sibling distance=2.0cm,level distance=0.5cm]
\tikzstyle{level 6}=[sibling distance=1.2cm,level distance=0.9cm]
\tikzstyle{level 7}=[sibling distance=2.0cm,level distance=0.5cm]
\tikzstyle{level 8}=[sibling distance=1.2cm,level distance=0.9cm]
