...
Our work is similar to that in \cite{Airiau:IJAT09} and in fact borrows from there the
...
``stability,'' is substantially more grounded than the one used in \cite{Airiau:IJAT09},
...
plan applicability thresholds. Contrary to what was implied in \cite{Airiau:IJAT09}, our
