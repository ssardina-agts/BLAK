...
calculate a confidence measure depending on how much of the relevant
subspace we are considering, has actually been explored.\footnote{This
  approach can actually be combined with the stability measure if
  desired.}
...
is thoroughly explored. This applies to both \BUL\ and \CL\ produced
decision trees, although the unreliable bias in each will be different.
