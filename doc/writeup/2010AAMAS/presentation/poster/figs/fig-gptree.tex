...
\tikzstyle{level 1}=[sibling distance=5.5em] 
\tikzstyle{level 2}=[sibling distance=7.5em] 
\tikzstyle{level 3}=[sibling distance=4.0em]
\tikzstyle{level 4}=[sibling distance=5.5em]
\tikzstyle{level 5}=[sibling distance=2.6em]
