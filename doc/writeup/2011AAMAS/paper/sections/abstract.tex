...
In this work we propose enhancements to a framework that integrates
...
%
This new measure dynamically adjusts based on agent performance, allowing in principle, infinitely many learning phases when used in the exploration heuristic. Additionally, it is scalable irrespective of the complexity of the goal-plan hierarchy implicit in the agent's plan library.
%
