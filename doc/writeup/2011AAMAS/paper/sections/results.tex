...
\subsubsection{Experiment 1: XXXXXXx}
...
% \begin{figure*}[t]
% \begin{center}
% \subfigure[Performance with different module failures over time.]{\label{fig:experiment2}
% \input{figs/fig-experiment2}
% }
% \qquad
% \subfigure[Performance with different module failures over time.]{\label{fig:experiment3}
% \input{figs/fig-experiment3}
% }
% \caption{Controller performance in the energy storage scenario.}
% \end{center}
