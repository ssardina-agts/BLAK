...
\vskip 0.25cm
A \alert{plan} is a {\em programmed} recipe for achieving a goal in some situation.\\\action{We wish to \alert{improve plan selection} in situations, based on {\em actual} experience.}
\end{center}
\note{
