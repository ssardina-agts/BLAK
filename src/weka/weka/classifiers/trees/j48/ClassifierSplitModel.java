...
public abstract class ClassifierSplitModel
  ...
  public final String dumpLabel(int index,Instances data) throws Exception {
    ...
    return text.toString();
      ...
      /** 
       * Returns number of instances in the bag at given index
       * Author: Dhirendra Singh
       */
      public double correctPerClass(int classIndex) {
          /* At the moment just returns total in class */
          return Utils.roundDouble(m_distribution.perClass(classIndex),2);
      }
