...
public class Towers{
    ...
    public void initFrame() {
        frame = new TowersFrame(title);
    }
    
    public void addDisc(int disc,int p) throws Exception {
        frame.canvas.addDisc(disc,p);
    }
    
    public Action moveDisc(int disc,int to) throws Exception {
        return frame.canvas.moveDisc(disc,to);
    }
    
    public void setCaption(String s) throws Exception {
        frame.canvas.setCaption(s);
    }
 ...
 **/
class TowersFrame extends Frame {
    
    public Drawable canvas;
    
    public TowersFrame(String title)
    {
        super(title);
